...
module Redcar
  ...
  - regex:    "interface\\s+(\\w+)"
    ...
    type:     id
    kind:     interface
  - regex:    "^\\s*((public|private|protected|)\\s+|)(static\\s+|)(([\\.\\w]+|)[A-Z]\\w*(<\\w+>|)|int|boolean|byte|short|long|char|float|def)\\s+(\\w+\\s*\\((.*)\\))"
    capture:  7
    type:     id
    kind:     method
  ...
  - regex:    "interface\\s+(\\w+)"
    ...
    type:     id
    kind:     interface
  - regex:    "((public|private|protected|)\\s+|)(static\\s+|)(([\\.\\w]+|)[A-Z]\\w*(<\\w+>|)|int|boolean|byte|short|long|char|float)\\s+(\\w+\\s*\\((.*)\\))"
    capture:  7
    type:     id
    kind:     method
  - regex:    "enum\\s+(\\w*)"
