...
Redcar.environment: #{Redcar.environment}
    ...
    def self.toolbars
      ToolBar::Builder.build do
        ...
        item "New Notebook", :command => NewNotebookCommand, :icon => File.join(Redcar::ICONS_DIRECTORY, "book--plus.png"), :barname => :notebook
        item "Close Notebook", :command => CloseNotebookCommand, :icon => File.join(Redcar::ICONS_DIRECTORY, "book--minus.png"), :barname => :notebook
      end
