...
Feature: Incremental Search
  ...
  Scenario: Open Find speedbar
    ...
    And I run the command DocumentSearch::IncrementalSearchSpeedbarCommand
    Then the DocumentSearch::IncrementalSearchSpeedbar speedbar should be open

  Scenario: Change settings
    When I run the command DocumentSearch::IncrementalSearchSpeedbarCommand
