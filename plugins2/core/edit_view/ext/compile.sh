...
gcc -I. -I/usr/local/lib/ruby/1.8/i686-linux -I/usr/local/lib/ruby/1.8/i686-linux -I.  -fPIC -g -O2  -c syntax_ext.c `pkg-config --cflags gtk+-2.0 gtksourceview-1.0` `pkg-config --libs gtk+-2.0 gtksourceview-1.0`
